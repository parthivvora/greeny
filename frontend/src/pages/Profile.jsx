...
function Profile() {
    ...
    const ref2 = useRef()
    const ref3 = useRef()
    const [userInfo, setUserInfo] = useState({ name: "", email: "", contact: "", address: "", addressType: "" })
    const [userImage, setUserImage] = useState(null)

    const getUserProfile = () => {
        makeApiRequest(apiTypes.GET, apiKeys.getUserProfile, null, null, null)
            .then((response) => {
                // console.log("🚀 ~ file: Profile.jsx:12 ~ .then ~ response:", response.data.userData.userImage)
                setUserInfo(response.data.userData)
                setUserImage(response.data.userData.userImage)
            })
            .catch((error) => {
                console.log("🚀 ~ file: Profile.jsx:15 ~ getUserProfile ~ error:", error)
    ...
    const handleEditUserInfo = (e) => {
        ...
        makeApiRequest(apiTypes.PUT, apiKeys.editUserProfile, formData, null, null)
            .then((response) => {
                // console.log("🚀 ~ file: Profile.jsx:31 ~ .then ~ response:", response)
                ref1.current.click()
                ref2.current.click()
                ref3.current.click()
            ...
            .catch((error) => {
                console.log("🚀 ~ file: Profile.jsx:34 ~ handleEditUserInfo ~ error:", error)
                alert(error.response.data.message)
            })
    }
    useEffect(() => {
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 col-lg-4">
                                            <div className="form-group">
                                                ...
                                                <input className="form-control" type="text" defaultValue={userInfo.name} readOnly />
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-lg-4">
                                            <div className="form-group">
                                                <label className="form-label">Email</label>
                                                <input className="form-control" type="email" defaultValue={userInfo.email} readOnly />
                                            </div>
                                        </div>
                                        <div className="col-lg-2">
                                            <div className="profile-btn"><a href="/change-password">change pass.</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 col-lg-4 alert fade show">
                                            <div className="profile-card address active">
                                                <h6>{userInfo.addressType ? userInfo.addressType : ""} </h6>
            ...
            <div className="modal fade" id="contact-add" ref={ref1}>
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <button className="modal-close" data-bs-dismiss="modal"><i className="fa-solid fa-xmark" /></button>
                        <form className="modal-form" method='post' onSubmit={handleEditUserInfo}>
                            <div className="form-title">
                                <h3>add new contact</h3>
                            </div>
                            <div className="form-group"><label className="form-label">number</label>
                                <input className="form-control" type="text" placeholder="Enter your number" name='contact' defaultValue={userInfo.contact} onChange={editUserInfo} />
                            </div>
                    ...
                    <div className="modal-content">
                        ...
                        <form className="modal-form" method='post' onSubmit={handleEditUserInfo}>
                            ...
                            <div className="form-group">
                                ...
                                <select className="form-select" name='addressType' onChange={editUserInfo}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea className="form-control" placeholder="Enter your address" name='address' defaultValue={userInfo.address} onChange={editUserInfo} />
                            </div>
                    ...
                    <div className="modal-content">
                        ...
                        <form className="modal-form" method='post' onSubmit={handleEditUserInfo}>
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-control" type="file" name='userImage' onChange={(e) => setUserImage(e.target.files[0])} />
                            </div>
                            <div className="form-group">
                                <label className="form-label">name</label>
                                <input className="form-control" type="text" name='name' defaultValue={userInfo.name} onChange={editUserInfo} />
                            </div>
                            <div className="form-group">
                                <label className="form-label">email</label>
                                <input className="form-control" type="email" name='email' defaultValue={userInfo.email} onChange={editUserInfo} />
                            </div>
