            ...
            <section className="inner-section single-banner" style={{ background: `url(${imageConstant.SINGLE_BANNER})`, backgroundPosition: "center", backgroundSize: "cover" }}>
                <div className="container">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active ps-1" aria-current="page">/ about</li>
                    </ol>
                </div>
            </section>
                    ...
                    <ul className="testi-slider slider-arrow">
                        <Slider {...aboutTestimonialOptions}>
                            <li>
                                <div className="testi-content">
                                    <a className="testi-img" href="#">
                                        <img src={require("../images/testimonial/01.jpg")} alt="01.jpg" />
                                    </a>
                            ...
                            <li>
                                <div className="testi-content">
                                    <a className="testi-img" href="#">
                                        <img src={require("../images/testimonial/02.jpg")} alt="01.jpg" />
                                    </a>
                                    <div className="testi-quote">
                                        <i className="fa-solid fa-quote-left"></i>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit neque earum sapiente vitae obcaecati magnam doloribus magni provident ab ipsam sint dolores repellat inventore sequi temporibus natus.</p>
                        ...
                        <div className="col-lg-12">
                            <ul className="team-slider slider-arrow">
                                <Slider {...teamSliderOptions}>
                                    <li>
                                        <figure className="team-media"><img src={require("../images/team/01.jpg")} alt="01.jpg" />
                                        ...
                                        <div className="team-meta mt-4">
                                            <h5><a href="#">Jhonson Hononr1</a></h5>
                                            <p>Founder &amp; CEO</p>
                                        </div>
                                    </li>
                                    <li>
                                        <figure className="team-media"><img src={require("../images/team/02.jpg")} alt="02.jpg" />
                                            <div className="team-overlay">
                                                <a href="#" className="fa-brands fa-facebook-f" />
                                                <a href="#" className="fa-brands fa-twitter" />
                                                <a href="#" className="fa-brands fa-linkedin" />
                                        ...
                                        <div className="team-meta mt-4">
                                            <h5><a href="#">Jhonson Hononr2</a></h5>
                                            <p>Web developer</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div className="team-meta mt-4">
                                            <h5><a href="#">Jhonson Hononr3</a></h5>
                                            <p>Founder &amp; CEO</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div className="team-meta mt-4">
                                            <h5><a href="#">Jhonson Hononr4</a></h5>
                                            <p>Web developer</p>
                                        </div>
                                    </li>
                                </Slider>
